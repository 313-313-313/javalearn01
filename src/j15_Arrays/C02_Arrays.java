...
public class C02_Arrays {
    public static void main(String[] args) {
        //Arr elemanı varlığını kontrol etme
        ...
        if (flag) {
            System.out.println("aradığınız sayı array da var :) ");
        } else {
            System.out.println("aradığınız sayı array da yok :( ");

        }
        Arrays.sort(arr); // array ın elemanları sıralandı
