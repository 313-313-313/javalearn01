...
public class C04_WrapperClass {
    public static void main(String[] args) {
       ...
       // primitive data turleri sadece degerleri saklarlar (container) ve hwerhangi bir özellik(method) vs bulundurmaz.//Ancak primitive data turleri icin de bazi işlemler için (String'den tamsayı çekme) method'lar ihtiyaç
      ...
      // ara çözüm imkanı sunmuştur.
        ...
        System.out.println(yeniId-yeniTC);// farkı=-1135690
        System.out.println(yeniId+yeniTC);// aritmetik toplama->1333220

       /* String okulNo="234543l";
        int yeniOkulNo= Integer.valueOf(okulNo);// run time Exception-> çalışma zamanı hatası (l sayıya dönüşmez)
        System.out.println("yeniOk ulNo = " + yeniOkulNo); */
