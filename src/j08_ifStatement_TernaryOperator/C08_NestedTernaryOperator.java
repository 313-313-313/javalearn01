 ...
 */
        ...
        System.out.println("agam ürün miktarı gir bakam : ");
        int urunMiktarı = sc.nextInt();
        System.out.println("agam ürün fiyatı gir bakam");
        int urunFiyati=sc.nextInt();

        double fatura=  urunMiktarı>1001 ? (urunMiktarı*urunFiyati*0.67):urunMiktarı*urunFiyati;
