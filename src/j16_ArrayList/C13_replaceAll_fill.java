...
public class C13_replaceAll_fill {
    public static void main(String[] args) {
        ...
        System.out.println("listSayi = " + listSayi); //replace öncesi -->listSayi = [1, 24, 23, 14, 19, 60, 1, 55, 27, 1, 38]

        Collections.replaceAll(listSayi,1,20); // sayi listine 1 yerine 20 atandı
        System.out.println("listSayi = " + listSayi); //replace sonrası -> listSayi = [20, 24, 23, 14, 19, 60, 20, 55, 27, 20, 38]
