...
public class C01_ArrayList {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> sayiList =new ArrayList<>(); // istediği kadar int değer saklayan yapı
...
​
 */        //list cerate etme ve değer atama
        ArrayList<Integer> listSayi=new ArrayList<>(); // boş integer type list oluşturuldu
        //1.yol ->add(); method
        listSayi.add(10);//list e ilk eleman olarak 10 değeri eklendi
        ...
        //2.yol -> ArraysList.asList(); method

        ArrayList<String> listİsim=new ArrayList<>(Arrays.asList("Muharrem","Nur","Enise","Fatih"));
        System.out.println("listİsim="+listİsim); // listİsim=[Muharrem, Nur, Enise, Fatih]

        //3. yol -> List.of(); method
        ArrayList<String> listUlke=new ArrayList<>(List.of("Alamanya","Amerigonya","İngiltere","İsveç"));
        listSayi.add(2,14); //listde index 2'ye 14 değeri eklendi 2. indexdeki eski eleman  bir ileri kaydırıldı
        System.out.println("lisSayi="+listSayi);
