...
public class C10_Sort_reverse {
    public static void main(String[] args) {
        //Collcetions.sort(list);  --> verilen list i natural sıralama return eder
        // Collcetions.reverse(list); --> verilen listin ters sıralamasını return eder
        ...
        //TRİCK-1 reverse yapmak için short yapmaya gerek yok
