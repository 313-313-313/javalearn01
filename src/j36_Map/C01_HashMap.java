 ...
 */
        ...
        hm.put("Apple store","500 Euro"); //Apple store key'deki value 333 Euro iken 500 Euro olarak update edildi.
        hm.put("Media Markt","183 Euro");

        //map sout komutuna parametre olarak print edilir.
        System.out.println("hm = " + hm); //hm = {null=222 Euro, Saturn=300 Euro, Ebay=null, Apple store=500 Euro, Media Markt=183 Euro, Amazon=296 Euro, Vatan=111 Euro}
