...
public class C07_containsKey_containsValue {
    public static void main(String[] args) {
        ...
        //map.containsKey();-> Girilen key değerinin map'te varlığını kontrol eder boolean return eder
        //map.containsValue();-> Girilen value değerinin map'te varlığını kontrol eder boolean return eder
