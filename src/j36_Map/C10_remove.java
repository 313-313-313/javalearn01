...
public class C10_remove {
    public static void main(String[] args) {
        ...
        //map.remove();->Girilen entry map'te varsa siler ve true return eder yoksa false return eder
        //parametre olarak entry değil sadece key değer girilirse key varsa siler ve key value'sini return eder yoksa null return eder
        ...
        System.out.println("hm.remove(\"111 Euro\") = " + hm.remove("111 Euro")); //nulllll

        System.out.println("hm = " + hm); //{Saturn=300 Euro, Apple store=333 Euro, Media Markt=183 Euro, Vatan=111 Euro}
