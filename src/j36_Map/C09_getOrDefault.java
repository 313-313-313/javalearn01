...
public class C09_getOrDefault {
    public static void main(String[] args) {
        ...
        //map.getOrDefault();->Girilen key map'te varsakey'a ait value yoksa default değer return eder.
        ...
        //Ebay key map te olduğu için Ebay key'e ait value:234 Euro return edildi.
        System.out.println("hm.getOrDefault(\"ebik\",\"gabık\") = " + hm.getOrDefault("ebik", "gabık")); //gabık
        //ebik key map'te olmadığı için bu key default değer gabık atanıp return edildi.
