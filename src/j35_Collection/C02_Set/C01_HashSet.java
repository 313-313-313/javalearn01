...
​
    ...
    public static void main(String[] args) {
        ...
        HashSet<String>hs1=new HashSet<>(Arrays.asList("Ercan","Yakup","Adem","Rukiye","Nur"));//eleman ataması yapılan hasset
        ...
        System.out.println("hs2 = " + hs2); //hs2 = [Basarı, Asıktır, Gayrete]
        hs1.addAll(hs2);
        System.out.println("hs1 = " + hs1); //hs1 = [null, Basarı, Ercan, Adem, Kevser, Asıktır, Nur, Yakup, Rukiye, Gayrete]
        ...
        System.out.println("hs1 = " + hs1); //hs1 = [null, Basarı, Ercan, Adem, Kevser, Nur, Yakup, Rukiye, Gayrete]
        ...
        System.out.println("hs2.hashCode() = " + hs2.hashCode()); //hs2.hashCode() = 303715832
    }
}
